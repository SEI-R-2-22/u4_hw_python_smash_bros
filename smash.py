...
class Battle:
    ...
    def battling(self):
        # print(self.character_two.random_move()['damage'])
        while self.character_one.health > 0 and self.character_two.health > 0:
            ...
            print(self.character_two.name + "Attacks!! ")
            self.character_two.decrement_health(
                self.character_one.random_move()['damage'])
            print(self.character_one.name + " Attacks!!")

        print("Winner is " + self.character_one.name if self.character_one.health else self.character_two.name)
